...
def run_training(args: Namespace, logger: Logger = None) -> List[float]:
    ...
    if args.separate_val_path and args.separate_test_path:
        ...
        train_data, _, test_data = split_data(data=data, split_type=args.split_type, sizes=(0.8, 0.2, 0.0), seed=args.eseed, args=args, logger=logger)
    ...
    for model_idx in range(args.ensemble_size):
        ...
        scheduler = build_lr_scheduler(optimizer, args, scheduler_name='Noam')
